# data-platform-api-usage-control-chain-creates-rmq-kube

data-platform-api-usage-control-chain-creates-rmq-kube は、周辺業務システム　を データ連携基盤 と統合することを目的に、API でオーダーデータを登録/更新するマイクロサービスです。
